...
abstract class $RouteCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String name, String type, String grade, int sectorId});
}
...
class _$RouteImpl implements _Route {
  ...
  @override
  String toString() {
    return 'Route(id: $id, name: $name, type: $type, grade: $grade, sectorId: $sectorId)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, type, grade, sectorId);
...
abstract class _Route implements Route {
  const factory _Route(
      ...
      required final int sectorId}) = _$RouteImpl;
